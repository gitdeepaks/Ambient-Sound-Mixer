export class UI {
  constructor() {
    ...
    this.modal = null; // save preset modal
  ...
  //Create SoundCard HTML
  createSoundCard(sound) {
    const card = document.createElement('div');
    card.className =
      'sound-card bg-white/10 backdrop-blur-md p-6 relative rounded-2xl overflow-hidden transition-all duration-300';
